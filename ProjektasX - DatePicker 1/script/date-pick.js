      ...
      var html =   "<div id='date-pick' class='date-pick text-center'>"
                  + "<div id='date-pick-body-current' class='date-pick-body'>"
                    ...
                    + "<div id='date-pick-week-days-current' class='date-pick-week-days'>"
                      + "<span class='date-pick-week-day'>Pr</span>"
                      + "<span class='date-pick-week-day'>An</span>"
                      + "<span class='date-pick-week-day'>Tr</span>"
                      + "<span class='date-pick-week-day'>Ke</span>"
                      + "<span class='date-pick-week-day'>Pn</span>"
                      + "<span class='date-pick-week-day'>Še</span>"
                      + "<span class='date-pick-week-day'>Sk</span>"
                    + "</div>"
...
//       document.getElementById("date-pick").classList.add('show-date-pick');
      alert('hi');
    console.log('hi');
  });
